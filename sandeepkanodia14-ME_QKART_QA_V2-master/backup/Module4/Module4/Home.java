...
public class Home {
    ...
    ExpectedConditions.presenceOfElementLocated(
        By.xpath("//div[contains(@class,'MuiCardContent-root')]/p")
    ),
    ExpectedConditions.presenceOfElementLocated(
        By.xpath("//div[contains(@class,'loading MuiBox-root')]")
    )
));
            try{
                driver.findElement(By.xpath("//div[contains(@class,'loading MuiBox-root')]"));
                return false;
            }
            catch(Exception e){
                return true;
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            WebElement cartParent = driver.findElement(By.className("cart"));
            List<WebElement> cartContents = cartParent.findElements(By.xpath("(//div[contains(@class,'cart')])[1]"));

            ArrayList<String> actualCartContents = new ArrayList<String>() {
            };
            for (WebElement cartItem : cartContents) {
                actualCartContents.add(cartItem.findElement(By.xpath(".//div[contains(@class,'image-container')]//following-sibling::div[contains(@class,'MuiBox-root')]")).getText().split("\n")[0]);
            }
